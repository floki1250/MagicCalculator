<template>
  <div
    class=" blur-blob absolute top-52 left-1/3 md:top-20 md:left-50 lg:top-20 lg:left-1/3 bg-gradient-to-r from-[#FF0F7B] dark:from-indigo-800 to-[#F89B29] dark:to-[#F89B29]  w-60 h-60 md:w-80 md:h-80 sm:w-60 sm:h-60 lg:w-[30rem] lg:h-[30rem]">
  </div>
  <div>
    ...
    <NuxtLayout class="overflow-y-scroll">
